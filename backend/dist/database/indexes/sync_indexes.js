...
exports.synchronizeDatabaseIndexes = synchronizeDatabaseIndexes;
const atlas_pool_1 = require("../connections/atlas_pool");
const Models = __importStar(require("../models/index"));
const index_registry_1 = require("./index_registry");
/**
 ...
 */
async function synchronizeDatabaseIndexes() {
    ...
    console.log(`   📌 Total Declarative Indexes in Registry: ${index_registry_1.indexRegistry.length}`);
